...
class AnalysisSettings(BaseModel):
    ...
    min_confluence_score: float = Field(2.5, description="Minimum confluence factors")
    min_rr_ratio: float = Field(2.0, description="Minimum risk/reward ratio")
    require_perfect_structure: bool = Field(False, description="Require CHoCH/MSS for signals")
...
class QualitySettings(BaseModel):
    ...
    min_quality_score: float = Field(0.45, description="Minimum quality score (45%)")
